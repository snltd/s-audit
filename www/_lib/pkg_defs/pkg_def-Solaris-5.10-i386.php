...
//============================================================================
//
// Package definition file for i386 SunOS 5.10.
//
// Generated Thu Apr  8 15:21:12 BST 2010 by s-audit_pkgdefs.sh
//
//============================================================================
...
$hover_arr = array(
	...
	"SUNWPython-devel" => "The Python interpreter, libraries and utilities - develper files - platform dependent, /usr filesystem",
	...
	"SUNWbdb" => "BerkeleyDB-Base 4.2.52 (sun-private) Solaris x86 Intel Architecture",
	"SUNWbdbj" => "BerkeleyDB-Java(sun-private) 4.2.52 Solaris x86 Intel Architecture",
	...
	"SUNWflash-player-plugin" => "Macromedia Flash Player plugin",
	...
	"SUNWgnome-im-client-share" => "GNOME Multi-protocol instant messaging client - platform independent files, /usr/share",
	...
	"SUNWgscr" => "espgs - ESP GhostScript",
	"SUNWgscrS" => "espgs - ESP GhostScript (Source)",
	...
	"SUNWj5cfg" => "JDK 5.0 Host Config. (1.5.0_20)",
	"SUNWj5dev" => "JDK 5.0 Dev. Tools (1.5.0_20)",
	"SUNWj5dmo" => "JDK 5.0 Demo Programs (1.5.0_20)",
	"SUNWj5dmx" => "JDK 5.0 64-bit Demo Programs (1.5.0_20)",
	"SUNWj5dvx" => "JDK 5.0 64-bit Dev. Tools (1.5.0_20)",
	"SUNWj5jmp" => "JDK 5.0 Man Pages: Japan (1.5.0_20)",
	"SUNWj5man" => "JDK 5.0 Man Pages (1.5.0_20)",
	"SUNWj5rt" => "JDK 5.0 Runtime Env. (1.5.0_20)",
	"SUNWj5rtx" => "JDK 5.0 64-bit Runtime Env. (1.5.0_20)",
	...
	"SUNWnv-sata" => "Nvidia ck804 pro / mcp55 pro combo SATA driver",
	"SUNWnxge.i" => "Sun NIU leaf driver",
	...
	"SUNWpostgr" => "PostgreSQL 8.1.17 client programs and libraries",
	...
	"SUNWpostgr-contrib" => "Contributed source and binaries distributed with PostgreSQL 8.1.17",
	"SUNWpostgr-devel" => "PostgreSQL 8.1.17 development header files and libraries",
	"SUNWpostgr-docs" => "Extra documentation for PostgreSQL 8.1.8",
	...
	"SUNWpostgr-libs" => "The shared libraries required for any PostgreSQL 8.1.17 clients",
	"SUNWpostgr-pl" => "The PL procedural languages for PostgreSQL 8.1.17",
	"SUNWpostgr-server" => "The programs needed to create and run a PostgreSQL 8.1.17 server",
	"SUNWpostgr-server-data" => "The data directories needed to create and run a PostgreSQL 8.1.8 server",
	...
	"SUNWpostgrS" => "PostgreSQL 8.1.8 (Source)",
	...
	"SUNWrealplayer-l10n-pl" => "RealPlayer media application - l10n-pl files",
	...
	"SUNWstaroffice-base" => "Base module for StarOffice 8",
	"SUNWstaroffice-calc" => "Calc module for StarOffice 8",
	"SUNWstaroffice-core01" => "Core module for StarOffice 8",
	"SUNWstaroffice-core02" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core03" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core04" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core05" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core06" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core07" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core08" => "Office core module for StarOffice 8",
	"SUNWstaroffice-core09" => "Office core module for StarOffice 8",
	"SUNWstaroffice-de" => "Language module for StarOffice 8, language de",
	"SUNWstaroffice-de-help" => "Language help module for StarOffice 8, language de",
	"SUNWstaroffice-de-res" => "Language resource module for StarOffice 8, language de",
	"SUNWstaroffice-draw" => "Draw module for StarOffice 8",
	"SUNWstaroffice-es" => "Language module for StarOffice 8, language es",
	"SUNWstaroffice-es-help" => "Language help module for StarOffice 8, language es",
	"SUNWstaroffice-es-res" => "Language resource module for StarOffice 8, language es",
	"SUNWstaroffice-fr" => "Language module for StarOffice 8, language fr",
	"SUNWstaroffice-fr-help" => "Language help module for StarOffice 8, language fr",
	"SUNWstaroffice-fr-res" => "Language resource module for StarOffice 8, language fr",
	"SUNWstaroffice-gallery" => "Optional gallery for StarOffice 8",
	"SUNWstaroffice-gnome-integration" => "GNOME integration module for StarOffice 8",
	"SUNWstaroffice-graphicfilter" => "Graphic filter module for StarOffice 8",
	"SUNWstaroffice-impress" => "Impress module for StarOffice 8",
	"SUNWstaroffice-it" => "Language module for StarOffice 8, language it",
	"SUNWstaroffice-it-help" => "Language help module for StarOffice 8, language it",
	"SUNWstaroffice-it-res" => "Language resource module for StarOffice 8, language it",
	"SUNWstaroffice-javafilter" => "Java filter module for StarOffice 8",
	"SUNWstaroffice-lngutils" => "Language utilities for StarOffice 8",
	"SUNWstaroffice-math" => "Math module for StarOffice 8",
	"SUNWstaroffice-menuintegration" => "Desktop integration for StarOffice (usr)",
	"SUNWstaroffice-ooofonts" => "Office fonts module for StarOffice 8",
	"SUNWstaroffice-pt-BR" => "Language module for StarOffice 8, language pt-BR",
	"SUNWstaroffice-pt-BR-help" => "Language help module for StarOffice 8, language pt-BR",
	"SUNWstaroffice-pt-BR-res" => "Language resource module for StarOffice 8, language pt-BR",
	"SUNWstaroffice-sunsearchtoolbar" => "Sun search toolbar for StarOffice 8",
	"SUNWstaroffice-sv" => "Language module for StarOffice 8, language sv",
	"SUNWstaroffice-sv-help" => "Language help module for StarOffice 8, language sv",
	"SUNWstaroffice-sv-res" => "Language resource module for StarOffice 8, language sv",
	"SUNWstaroffice-writer" => "Writer module for StarOffice 8",
	"SUNWstaroffice-xsltfilter" => "XSLT filter samples module for StarOffice 8",
	"SUNWstarsuite-base" => "Base module for StarSuite 8",
	"SUNWstarsuite-calc" => "Calc module for StarSuite 8",
	"SUNWstarsuite-core01" => "Core module for StarSuite 8",
	"SUNWstarsuite-core02" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core03" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core04" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core05" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core06" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core07" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core08" => "Office core module for StarSuite 8",
	"SUNWstarsuite-core09" => "Office core module for StarSuite 8",
	"SUNWstarsuite-draw" => "Draw module for StarSuite 8",
	"SUNWstarsuite-gallery" => "Optional gallery for StarSuite 8",
	"SUNWstarsuite-gnome-integration" => "GNOME integration module for StarSuite 8",
	"SUNWstarsuite-graphicfilter" => "Graphic filter module for StarSuite 8",
	"SUNWstarsuite-impress" => "Impress module for StarSuite 8",
	"SUNWstarsuite-ja" => "Language module for StarSuite 8, language ja",
	"SUNWstarsuite-ja-fonts" => "Language fonts module for StarSuite 8, language ja",
	"SUNWstarsuite-ja-help" => "Language help module for StarSuite 8, language ja",
	"SUNWstarsuite-ja-res" => "Language resource module for StarSuite 8, language ja",
	"SUNWstarsuite-javafilter" => "Java filter module for StarSuite 8",
	"SUNWstarsuite-ko" => "Language module for StarSuite 8, language ko",
	"SUNWstarsuite-ko-fonts" => "Language fonts module for StarSuite 8, language ko",
	"SUNWstarsuite-ko-help" => "Language help module for StarSuite 8, language ko",
	"SUNWstarsuite-ko-res" => "Language resource module for StarSuite 8, language ko",
	"SUNWstarsuite-lngutils" => "Language utilities for StarSuite 8",
	"SUNWstarsuite-math" => "Math module for StarSuite 8",
	"SUNWstarsuite-menuintegration" => "Desktop integration for StarOffice (usr)",
	"SUNWstarsuite-ooofonts" => "Office fonts module for StarSuite 8",
	"SUNWstarsuite-sunsearchtoolbar" => "Sun search toolbar for StarSuite 8",
	"SUNWstarsuite-writer" => "Writer module for StarSuite 8",
	"SUNWstarsuite-xsltfilter" => "XSLT filter samples module for StarSuite 8",
	"SUNWstarsuite-zh-CN" => "Language module for StarSuite 8, language zh-CN",
	"SUNWstarsuite-zh-CN-fonts" => "Language fonts module for StarSuite 8, language zh-CN",
	"SUNWstarsuite-zh-CN-help" => "Language help module for StarSuite 8, language zh-CN",
	"SUNWstarsuite-zh-CN-res" => "Language resource module for StarSuite 8, language zh-CN",
	"SUNWstarsuite-zh-TW" => "Language module for StarSuite 8, language zh-TW",
	"SUNWstarsuite-zh-TW-fonts" => "Language fonts module for StarSuite 8, language zh-TW",
	"SUNWstarsuite-zh-TW-help" => "Language help module for StarSuite 8, language zh-TW",
	"SUNWstarsuite-zh-TW-res" => "Language resource module for StarSuite 8, language zh-TW",
	...
	"SUNWthunderbirdl10n-extra" => "Thunderbird localization - other 15 lang",
