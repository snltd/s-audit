...
?>
	...
	<dt>distribution</dt>
	<dd>Displays the Solaris &quot;distribution&quot;. For Solaris 10 and
	older, Sun branded releases, this will be &quot;Solaris&quot;. Solaris
	Nevada/Express Community Edition is reported as &quot;SXCE&quot;. Other
	distributions include BeleniX, OpenSolaris, OpenIndiana, Solaris 11
	Express, and Nexenta.</dd>

	<dt>version</dt>
	<dd>Displays the version of the operating system. For Solaris 10 and
	earlier this is the marketing release number, for instance &quot;Solaris
	2.6&quot;, with the SunOS release number, e.g. 5.6, in parentheses. For
	the newer OpenSolaris based distributions, only the SunOS version is
	displayed.</dd>

	<dd>If a local zone has a different version to its global parent, it
	will be in an amber box.</dd>
	...
	update number. For instance, a Solaris 10 update 8 installation will
	display  &quot;10/09 (update 8)&quot;. OpenSolaris based releases
	display the release of the distribution. For instance, a Nexenta release
	may display as &quot;3.0 (Hardy 8.04/b134+)&quot;, and an SXCE release
	as &quot;snv_129&quot;. Some distributions do not provide a useful
	release number, in which case no information will be displayed.</dd>
	...
	<dt>kernel</dt>
	<dd>For SYSV packaged systems, i.e. Solaris 10 and earlier, this
	displays the revision of the kernel patch installed on the system (for
	instance 144488-04). Most
	5.11 based releases display the kernel number (e.g. 130), but some
	distributions, for instance BeleniX, use their own numbering
	system.</dd>

	<dd>If you have a number of machines with the same Solaris version, that
	is with identical values in the <strong>distribution</strong> and
	<strong>version</strong> fields, and the same hardware architecture,
	then the machines in that set with the most recent kernel version will
	have this box highlighted in green. Older kernel versions will be red.
	This helps you see which, if any, machines may require patching.</dd>

	<dd>Local zones which do not have the same kernel version as their
	global parent are highlighted by an amber box. Note that branded zones
	display their kernel version as &quot;Virtual&quot;</dd>
	...
	root directory in parentheses. If a zone is not &quot;running&quot; or
	&quot;installed&quot;, its state is displayed between the zone name and
	the zone root. Branded zones have their brand type displayed in square
	brackets.</dd>
