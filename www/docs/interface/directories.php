...
<p>Transient data is kept in <tt>/var</tt>. This includes all machine audit
data and extra files.</p>
...
<p>The interface itself uses the following directory structure. Don't change
it.</p>
