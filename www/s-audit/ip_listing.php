...
$pg = new audPage("IP address list", $grid->server_count(),
$grid->zone_toggle());

// We make three lists of used IP addresses, which have descending
// "priorities"
//
// s_list comes from the IP_LIST FILE file generated by s-audit_subnet.sh.
//        This is considered canonical, and its information is on a green
//        field
// l_list is active machines, pulled from the audit files. An address used
//        here but not in s_list is coloured amber
// h_list comes from the hand-made "reserved" list
// 
// Each of these lists 

$s_list = $s_nets = $s_addrs = $l_list = $h_list = $h_nets = $h_addrs =
$o_list = array();

// First off, if we have the IP_LIST_FILE generated by s-audit_subnet.sh,
// we'll get the addresses in that
